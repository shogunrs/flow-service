...
const pipelineKey = computed(() => sanitizeProcessKey(String(route.params.process || 'quotaequity')) || 'quotaequity')
...
const Inner = defineAsyncComponent(() => import('~/pages/esteira/index.vue').then(m => m.default || m))
