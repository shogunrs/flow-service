...
public class Stage {
    ...
    public Stage(String id, String processKey, String title, Integer slaDays, String color, String defaultStatus, Integer order, Instant createdAt, Instant updatedAt) {
        this.id = id;
