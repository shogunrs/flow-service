...
public class DataMigrationService {
    ...
    public static class MigrationResult {
        ...
        public long updatedStageFields() {
            return updatedStageFields;
        }

        public long processedStages() {
    ...
    public MigrationResult migrateStageFieldsWithProcessExternalId() {
        ...
        try {
            ...
            List<Map<String, Object>> stageFields = (List<Map<String, Object>>) (List<?>) mongoTemplate
                    .find(findStageFieldsWithoutProcess, Map.class, "stage_fields");
            ...
            for (Map<String, Object> stageField : stageFields) {
                ...
                if (stageId != null) {
                    ...
                    @SuppressWarnings("unchecked")
                    Map<String, Object> stageDoc = (Map<String, Object>) mongoTemplate.findOne(stageQuery, Map.class,
                            "stages");
    ...
    public Map<String, Object> validateDataIntegrity() {
        try {
            ...
            @SuppressWarnings("unchecked")
            List<Map<String, Object>> allFields = (List<Map<String, Object>>) (List<?>) mongoTemplate.findAll(Map.class,
                    "stage_fields");
