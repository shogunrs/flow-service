...
public class OrphanDataCleanupService {
    ...
    public static class OrphanCleanupResult {
        ...
        public Map<String, Long> deletedCounts() {
            return deletedCounts;
        }

        public List<String> orphanedProcessKeys() {
            return orphanedProcessKeys;
        }
    ...
    public OrphanCleanupResult findOrphanDataOnly() {
        ...
        try {
            ...
            long executionTime = System.currentTimeMillis() - startTime;
            return new OrphanCleanupResult(false, orphanCounts, orphanedProcessKeys, executionTime,
